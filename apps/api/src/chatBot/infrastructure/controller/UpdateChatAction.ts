...
import { ChatResponseDto } from '../../application/query/dto/ChatResponseDto';
...
import { GetChatQuery } from '../../application/query/GetChatQuery';
...
export class UpdateChatAction {
    ...
    async invoke(
        @Param('id') id: string,
        @Body() requestDto: UpdateChatRequest,
